...
public:
    ...
    // restore_item gold=restore_item(1000,"金币","各个大陆的流通货币",0);
    // restore_item blood_l=restore_item(1001,"小血瓶","小型的血量回复药，可以恢复50点血量",50);
    // restore_item blood_m=restore_item(1002,"中血瓶","中型的血量回复药，可以恢复50点血量",100);
    // restore_item blood_x=restore_item(1003,"中血瓶","大型的血量回复药，可以恢复150点血量",150);
    // restore_item mana_l=restore_item(1004,"小蓝瓶","小型的魔力回复药，可以恢复50点魔力",50);
    // restore_item mana_m=restore_item(1005,"中蓝瓶","中型的魔力回复药，可以恢复50点魔力",100);
    // restore_item mana_x=restore_item(1006,"大蓝瓶","大型的魔力回复药，可以恢复150点魔力",150);
    // non_restore_item ball_l=non_restore_item(1007,"基础精灵球","最低级的精灵球，小概率捕捉到精灵",20);
    // non_restore_item ball_m=non_restore_item(1008,"进阶精灵球","进阶的精灵球，大概率捕捉到精灵",50);
    // non_restore_item ball_x=non_restore_item(1009,"大师精灵球","最高级的精灵球，必定捕捉到精灵",100);
    void showback()
    {
        for(int i=0;i<10;i++)
        {
